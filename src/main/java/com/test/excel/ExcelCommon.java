...
//不会把一组用例的数据放在一个sheet里面，这样的话不方便读，会放在不同的sheet里面，比如这个是登录、这个是数据添加、这个是其他数据添加，这样通过sheet工作表来控制
//本类主要实现后缀为xlsx的excel   文件操作
public class ExcelCommon {
    ...
    public ExcelCommon(String Path, String SheetName) throws Exception{ //构造函数做类初始化的
